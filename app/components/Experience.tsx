...
export default function Experience({ setActiveSection }: ExperienceProps) {
  ...
  const experiences: ExperienceItem[] = [
    ...
    },
    {
      ...
      projects: [
        // "Built a predictive maintenance system for industrial equipment",
        // "Developed a fraud detection algorithm for financial transactions",
        // "Implemented a customer churn prediction model",
  ...
  return (
    <section id="experience" ref={sectionRef} className="py-20 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-center text-indigo-800 dark:text-indigo-400">Professional Experience</h2>
