        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <motion.div
              ...
              className="h-16 bg-gray-200 dark:bg-slate-600 rounded-lg mb-6 max-w-2xl mx-auto"
            />
            <motion.div
              initial={{ opacity: 0.6 }}
              animate={{ opacity: [0.6, 1, 0.6] }}
              transition={{ duration: 1.5, repeat: Infinity, delay: 0.2 }}
              className="h-6 bg-gray-200 dark:bg-slate-600 rounded-lg mb-4 max-w-3xl mx-auto"
            />
            <motion.div
              initial={{ opacity: 0.6 }}
              animate={{ opacity: [0.6, 1, 0.6] }}
              transition={{ duration: 1.5, repeat: Infinity, delay: 0.4 }}
              className="h-6 bg-gray-200 dark:bg-slate-600 rounded-lg max-w-2xl mx-auto"
            />
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              className="h-96 bg-gray-200 dark:bg-slate-600 rounded-2xl mb-12"
            />
            ...
            <div className="mb-8">
              <motion.div
                ...
                className="h-12 bg-gray-200 dark:bg-slate-600 rounded-lg mb-6 max-w-3xl"
              />
              <div className="flex flex-wrap gap-3 mb-6">
                {[1, 2, 3, 4, 5].map((i) => (
                  <motion.div
                    ...
                    className="h-8 w-20 bg-gray-200 dark:bg-slate-600 rounded-full"
                  />
                ))}
              </div>
            </div>
            ...
            <div className="mb-12">
              <motion.div
                ...
                className="h-8 bg-gray-200 dark:bg-slate-600 rounded-lg mb-6 max-w-xs"
              />
            ...
            <div className="flex gap-4">
              <motion.div
                ...
                className="h-12 w-32 bg-gray-200 dark:bg-slate-600 rounded-full"
              />
              <motion.div
                initial={{ opacity: 0.6 }}
                animate={{ opacity: [0.6, 1, 0.6] }}
