...
export default function Skills({ setActiveSection }: SkillsProps) {
  ...
  if (!mounted) {
    return <section id="skills" className="py-16 md:py-20 bg-gray-50"></section>
  }

  return (
    <section id="skills" ref={sectionRef} className={`py-16 md:py-20 transition-colors duration-300 ${
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          {/* <div className="h-1 w-20 md:w-24 bg-blue-600 mx-auto mb-6"></div>
            ...
            >
              <Card 
                className={`h-full overflow-hidden border ${
                  ...
                  expandedCategory === index ? `border-l-4 ${
                    isDark ? 'border-l-' + category.darkAccentColor.split('-').pop() : 
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-2">
                          {category.skills.map((skill) => (
                            ...
                            >
                              ...
                              <span className={`text-xs font-medium truncate w-full mb-1 ${
